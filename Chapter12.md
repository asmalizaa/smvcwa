...
5. The application class.
   ...
   ```
6. Run the application and test using browser/postman. Type this address (http://localhost:8080/api/students)

   ![image](https://github.com/asmalizaa/smvcwa/assets/23090837/b44fc637-bffe-465d-8d63-c395f3f3ef29)

   Verify the interceptor is executed. Check the console message.

   ![image](https://github.com/asmalizaa/smvcwa/assets/23090837/0e584782-6a2c-4738-90e1-6a0743af2264)
